  ...
  const items = [
    {
      ...
      a: "Only if you want to. Finch hosts the server, it doesn't write it. Bring a FastMCP (or any MCP) server and Finch wraps it in auth and a public URL. If you've shipped a FastMCP server, you already know the shape. Or grab a ready-made server and put it on a box in a minute.",
    },
    {
